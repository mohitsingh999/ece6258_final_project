-------------------------------------------------------------------
  ...
  BM3D demo software for image/video restoration and enhancement  
                   Public release v2.01 (3 October 2021) 
...
BM3D web page:            https://webpages.tuni.fi/foi/GCF-BM3D
...
*) BM3D.m +L+    : BM3D grayscale-image denoising [1]
*) CBM3D.m +L+   : CBM3D RGB-image denoising [2]
*) BM3DDEB.m +L+ : BM3D-DEB grayscale-image deblurring [5]
...
[+L+] these are legacy releases. The recent implementations of BM3D,
      CMB3D and BM3DDEB, for both Python and Matlab, are found in a
      separate page at https://webpages.tuni.fi/foi/GCF-BM3D/
...
-------------------------------------------------------------------
 Changelog
-------------------------------------------------------------------
v2.01   (3 October 2021)
 ! updated function_WOSFilters.p files for compatibility with
   newer Matlab releases of BM3D-SAPCA
...
[10] A. Danielyan, M. Vehvil&auml;inen, A. Foi, V. Katkovnik, and
...
terms of the TUT/TAU limited license:
https://webpages.tuni.fi/foi/GCF-BM3D/legal_notice.html
...
contact    Alessandro Foi   at  firstname.lastname@tuni.fi
